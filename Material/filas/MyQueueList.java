...
/**
 * Objetivo: Fila sobre Lista simplesmente encadeada
 * Observacao: implementacao com generic.
 * @author Bruno Monteiro
 */
public class MyQueueList <T> implements MyInterfaceQueue <T>
{
	// Classe Interna Node
	class Node
	{
    ...
    // Construtor
	public MyQueueList(long capacity) {
		this.head = null;
		this.tail = null;
		this.size = 0;
	...
	@Override
	public void add(T dado) throws MyException 
	{
		// Adicionar no fim
	    if( isFull() ) {
